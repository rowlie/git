...
export function getAnnotations(props: Record<string, string>) {
...
export function getFieldPath(props: Record<string, string>) {
    return props['data-sb-field-path'] || '';
}

export function getObjectId(props: Record<string, string>) {
